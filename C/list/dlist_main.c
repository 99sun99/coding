...
//  find head or position with size not like usual method

#include <stdio.h>
#include <stdlib.h>

#include "D:\trainning_course\C\list\dlist.h"
#include "D:\trainning_course\C\list\dlist.c"
