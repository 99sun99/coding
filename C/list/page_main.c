...
#include "D:\trainning_course\C\LearningMasteringAlgorithms-C\source\list\page.h"
#include "D:\trainning_course\C\LearningMasteringAlgorithms-C\source\list\page.c"
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < 10; i++) {
    ...
    if (clist_ins_next(&list, current, p) != 0) return 1; //list 每个 data都对应着自己的page
  ...
  for (i = 0; i < 10; i++) {
    ...
    p = clist_data(current);//data is page
